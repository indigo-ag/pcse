...
class SnowMAUS(SimulationObject):
    ...
    **Rate variables:**
    ...
    def initialize(self, day, kiosk, parvalues):
        ...
        if parvalues["SNOWDENSITY"] <= 0.0:
            msg = (
                "SNOWDENSITY parameter of SnowMAUS module cannot <= zero "
        ...
        self.states = self.StateVariables(
            kiosk, SWEDEPTH=SWEDEPTH, SNOWDEPTH=SNOWDEPTH, publish="SNOWDEPTH"
        )
    ...
    def calc_rates(self, day, drv):
        ...
        if s.SWEDEPTH > p.SCTHRESHOLD and r.RSNOWACCUM == 0.0:
            RSNOWSUBLIM = drv.E0
        else:
            RSNOWSUBLIM = 0.0
        ...
        if drv.TMIN < p.TMINCRIT:
            ...
            if drv.TMIN <= 0.0 and drv.TMAX < p.TMAXCRIT:
                RSNOWMELT = 0.0
            else:
