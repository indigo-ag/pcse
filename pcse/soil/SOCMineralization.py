...
class SOCMineralization_Indigo(SimulationObject):
    ...
    def calc_rates(self, day, drv):
        ...
        mineralized_N_active = decomp_carbon_active / self.params.CN_ratio_active * self.params.efficiency_active
        mineralized_N_slow = decomp_carbon_slow / self.params.CN_ratio_slow * self.params.efficiency_slow
        mineralized_N_passive = decomp_carbon_passive / self.params.efficiency_passive * self.params.efficiency_passive
